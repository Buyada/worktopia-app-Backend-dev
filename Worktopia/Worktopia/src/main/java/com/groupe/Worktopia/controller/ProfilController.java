...
public class ProfilController {
    ...
    public ResponseEntity<List<ProfilResDTO>> getProfiles(){
        return ResponseEntity
                .status(201)
    ...
    public ResponseEntity<String> updateProfile(Integer profileId, @Valid @RequestBody ProfilReqDTO profilReqDTO){
        this.profilService.updateProfil(profileId, profilReqDTO);
